...
function pageTwo() {
	$('body').removeClass().html('landing.html');
};
function gotologinpage() {
	$('body').removeClass().html('login.html');
};
function gotolandingagain() {
	$('body').removeClass().html('landing.html');
};
function gotodashboard() {
	$('body').removeClass().html('dashboard.html');
};
function favOverlayActions() {
	console.log('favOverlayActions ...');
