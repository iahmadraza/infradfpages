...
$(function () {
	...
	$('body').on('click', function (e) {
		$('a.btn-quick-widget').removeClass('quick-widget-active');
	...
	//quick menu options 
	$('body').on('click', 'div.quick-widget a.btn-quick-widget', function (e) {
		e.stopPropagation();
		if (!$(this).hasClass('quick-widget-active')) {
			$(this).addClass('quick-widget-active');
			$('div.quick-widget-overlay').addClass('widget-overlay-showing').animate({top:45}, 500, function () {
	...
	if (iOSDevice) {
		...
		//Form element watermark label animation
		$('body').on('click touchstart', 'div.form-controller input, div.form-controller textarea', function (e) {
			$(this).addClass('input-focused').siblings('label').addClass('label-focused');
		});
		$('body').on('click touchstart', 'div.form-controller label', function (e) {
	...
	$('body').on('click', 'button.btn-menuitem-drop', function (e) {
		...
		if (!$(this).hasClass('btn-security-active')) {
			$(this).addClass('btn-security-active');
			$(this).siblings('div.menu-drop').addClass('menu-drop-showing');
			//console.log('sibling is showing');
		} else {
			$(this).removeClass('btn-security-active');
	...
	$('body').on('click', 'button.close-nav', function (e) {
		...
		$(this).closest('div.top-nav').animate({
			...
			$(this).hide();
			$('button.btn-menuitem-drop').removeClass('btn-security-active');
